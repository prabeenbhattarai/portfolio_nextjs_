  ...
  return (
    ...
    justify-center overflow-hidden md:right-8 md:left-auto
     ...
     <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
        ...
        <Link href="mailto:prabeenbhattarai7450@gmail.com?cc=info@bhattarai-prabin.com.np&subject=Exciting Opportunity: Join Our Team, We are Hiring[From Site:Bhattarai-Prabin.com.np]&body=Please Do not change subject for future communication " className='flex items-center justify-center
