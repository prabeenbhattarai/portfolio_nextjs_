...
import { GithubIcon, LinkedInIcon, MoonIcon, StackIcon, SunIcon, TwitterIcon, UpworkIcon } from './Icons'
...
const NavBar = () => {
  ...
  return (
   ...
   <nav>
    ...
    <motion.a href="https://github.com/prabeenbhattarai" target={"blank"} 
    whileHover = {{y:-2}}
    
    className='w-6 mx-3'>
    <GithubIcon/>
    </motion.a>
    <motion.a href="https://www.linkedin.com/in/prabeen-bhattarai-50839a187/" target={"blank"} 
    whileHover = {{y:-2}}
    whileTap={{scale:0.9}}
    className='w-6 mx-3'>
    <LinkedInIcon/>
...
className='min-w-[70vw] flex flex-col justify-between z-30 items-center 
   ...
   <nav className='flex items-center flex-col justify-center'>
    ...
    whileHover = {{y:-2}}
    whileTap={{scale:0.9}}
    className='w-6 ml-3 dar:fill-light sm:mx-1'>
    <StackIcon/>
    </motion.a>
<button onClick={ () => setMode(mode === "light" ? "dark" : "light")}
className={`ml-3 flex items-center justify-center rounded-full p-1'
